...
export const de = {
  ...
  [tokens.nav.lawSchPubManager]: 'LawSchPubManager',
  [tokens.nav.legalResources]: 'LegalResources',
  ...
  [tokens.nav.userAdmin]: 'Benutzeradministrator',
