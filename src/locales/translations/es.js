...
export const es = {
  ...
  [tokens.nav.fileManager]: 'Admin de Archivos',
  [tokens.nav.lawSchPubManager]: 'Admin de publicación',
  ...
  [tokens.nav.userAdmin]: 'Admin de Usuarios',
