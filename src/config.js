...
export const hasuraConfig = {
  hasuraEndpoint: process.env.NEXT_HASURA_GRAPHQL_ENDPOINT,
  hasuraAdminSecret: process.env.NEXT_HASURA_GRAPHQL_ADMIN_SECRET
};

export const composedbConfig = {
  host: process.env.NEXT_COMPOSE_DB_HOST,
  port: process.env.NEXT_COMPOSE_DB_PORT,
  username: process.env.NEXT_COMPOSE_DB_USERNAME,
  password: process.env.NEXT_COMPOSE_DB_PASSWORD,
  database: process.env.NEXT_COMPOSE_DB_DATABASE
};
